Feature: Add Products to Cart
  ...
  @boundary
  Scenario: Add a product to the cart with maximum quantity
    Given the user is on a product listing page
    When they click the "Add to Cart" button for the maximum allowed quantity of a product
    Then the cart should reflect the maximum quantity
    And a message should be displayed if the maximum limit is reached